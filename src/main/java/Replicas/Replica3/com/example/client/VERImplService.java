 ...
 * 
 */
@WebServiceClient(name = "VERImplService", targetNamespace = "http://example.com/ver", wsdlLocation = "http://localhost:8082/ver?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:8082/ver?wsdl");
