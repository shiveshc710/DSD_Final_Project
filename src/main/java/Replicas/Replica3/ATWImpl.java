...
public class ATWImpl {
    ...
    public static void main(String[] args) {
        String url = "http://localhost:8081/atw";
        Endpoint.publish(url, new ATWImpl());
        System.out.println("ATW is running and available at " + url + "?wsdl");
    }

    @WebMethod
    public String addMovieSlotsATW(String adminID, String movieID, String movieName, int bookingCapacity)  {
        Date date = new Date();
    ...
    @WebMethod
    public String removeMovieSlotsATW(String adminID, String movieID, String movieName)  {
        Date date = new Date();
        DateFormat dateFormat = DateFormat.getTimeInstance();
        String currentTime = dateFormat.format(date);
     ...
     */
    @WebMethod
    public String listMovieShowsAvailabilityATW(String movieName) {
        Date date = new Date();
        DateFormat dateFormat = DateFormat.getTimeInstance();
        String currentTime = dateFormat.format(date);
        ...
        try {
            ...
            logATW(currentTime, requestType, requestParameters, status, serverResponse, "");
        } catch (Exception e) {
            status = "Failure";
            serverResponse = "Server error";
            logATW(currentTime, requestType, requestParameters, status, serverResponse, "");
    ...
    @WebMethod
    public String bookMovieTicketsATW(String customerID, String movieID, String movieName, int numberOfTickets) {
        Date date = new Date();
        DateFormat dateFormat = DateFormat.getTimeInstance();
        String currentTime = dateFormat.format(date);
    ...
    @WebMethod
    public String cancelMovieTicketsATW(String customerID, String movieID, String movieName, int numberOfTickets) {
        Date date = new Date();
        DateFormat dateFormat = DateFormat.getTimeInstance();
        String currentTime = dateFormat.format(date);
    ...
    @WebMethod
    public String getBookingScheduleATW(String customerID) {
        Date date = new Date();
        DateFormat dateFormat = DateFormat.getTimeInstance();
        String currentTime = dateFormat.format(date);
    ...
    @WebMethod
    public void logATW(String currentTime, String requestType, String requestParameters, String status, String serverResponse, String userID) {
