...
public class OUTImpl {
    ...
    public static void main(String[] args) {
        String url = "http://localhost:8087/out";
        Endpoint.publish(url, new OUTImpl());
    ...
    public String addMovieSlotsOUT(String adminID, String movieID, String movieName, int bookingCapacity) {
        ...
        try {
            if (!movieInfo.containsKey(movieName)) {
                ...
                logOUT(currentTime, requestType, requestParameters, status, serverResponse, adminID);
    ...
    @WebMethod
    public String removeMovieSlotsOUT(String adminID, String movieID, String movieName) {
        Date date = new Date();
        DateFormat dateFormat = DateFormat.getTimeInstance();
        String currentTime = dateFormat.format(date);
     ...
     */
    @WebMethod
    public String listMovieShowsAvailabilityOUT(String movieName) {
        Date date = new Date();
        DateFormat dateFormat = DateFormat.getTimeInstance();
        String currentTime = dateFormat.format(date);
        ...
        try {
            ...
            logOUT(currentTime, requestType, requestParameters, status, serverResponse, "");
        } catch (Exception e) {
            status = "Failure";
            serverResponse = "Server error";
            logOUT(currentTime, requestType, requestParameters, status, serverResponse, "");
    ...
    @WebMethod
    public String bookMovieTicketsOUT(String customerID, String movieID, String movieName, int numberOfTickets) {
        Date date = new Date();
        DateFormat dateFormat = DateFormat.getTimeInstance();
        String currentTime = dateFormat.format(date);
        ...
        if (movieInfo.containsKey(movieName)) {
            ...
            if (value.containsKey(movieID)) {
                ...
                if (numberOfTickets <= capacityLeft) {
                    ...
                    logOUT(currentTime, requestType, requestParameters, status, serverResponse, customerID);
    ...
    @WebMethod
    public String cancelMovieTicketsOUT(String customerID, String movieID, String movieName, int numberOfTickets) {
        Date date = new Date();
        DateFormat dateFormat = DateFormat.getTimeInstance();
        String currentTime = dateFormat.format(date);
    ...
    @WebMethod
    public String getBookingScheduleOUT(String customerID) {
        Date date = new Date();
        DateFormat dateFormat = DateFormat.getTimeInstance();
        String currentTime = dateFormat.format(date);
    ...
    @WebMethod
    public void logOUT(String currentTime, String requestType, String requestParameters, String status, String serverResponse, String userID) {
