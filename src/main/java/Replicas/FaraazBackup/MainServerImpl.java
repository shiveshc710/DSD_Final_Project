...
public class MainServerImpl {
    ...
    public static void main(String[] args) {
        String url = "http://localhost:8084/mainserver";
    ...
    public String addMovieSlots(String adminID, String movieID, String movieName, int bookingCapacity) {
        ...
        if (adminID.startsWith("ATW")) {
            try {
                ...
                URL url = new URL("http://localhost:8085/atw?wsdl");
            ...
            try {
                URL url = new URL("http://localhost:8086/ver?wsdl");
            ...
            try {
                URL url = new URL("http://localhost:8087/out?wsdl");
    ...
    public String listMovieShowsAvailability(String movieName) {
        ...
        try {
            ...
            URL url2 = new URL("http://localhost:8086/ver?wsdl");
            ...
            URL url3 = new URL("http://localhost:8087/out?wsdl");
